...
def generate_test_card():
    ...
    try:
        resp = requests.get("https://gw.alicdn.com/bao/uploaded/i3/2214213105378/O1CN011St1Yq1pbAxuFvc3O_!!2214213105378.jpg_.webp", timeout=10)
        ...
        # template.paste(prod_img, (16, 65)) # Pasting on clean template later
    ...
    # draw.text((80, 15), shop_name, font=font, fill=(0, 0, 0, 255)) # Drawing on clean template later
    ...
    # draw.text((178, 60), title, font=title_font, fill=(0, 0, 0, 255)) # Drawing on clean template later
    ...
    # Adjusted positions
    draw_clean.text((535, 70), price, font=price_font, fill=(0, 0, 0, 255))
    draw_clean.text((530, 230), price, font=price_font, fill=(0, 0, 0, 255))
